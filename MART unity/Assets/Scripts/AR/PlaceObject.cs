...
public class ARPlacementInteraction : MonoBehaviour
{
   ...
   /* private void FingerMove(EnhancedTouch.Finger finger)
    ...
    void Update()
    {
        // В фото-режиме размещением управляет ARPhotoExhibitPlacer/Mover.
        // Этот сканирующий placer не должен реагировать на те же касания —
        // иначе он спавнит дубли моделей в мировых координатах.
