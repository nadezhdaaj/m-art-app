...
public class ARInteractionController : MonoBehaviour
{
    ...
    private void Update()
    {
        // В фото-режиме моделями управляет ARPhotoExhibitMover (перетаскивание).
        // Сканирующий контроллер выбора/вращения здесь только мешает и конфликтует
        // с фото-перетаскиванием, поэтому в фото-режиме он отключается.
